...
;;; 使用している elscreen: https://github.com/knu/elscreen
(require 'elscreen)
...
;;                       (my-el__screen-truncate-screen-name
;;                        (reduce (lambda (x f) (funcall f x)) elscreen-my-title-maps
;;                                :initial-v^alue (get-alist screen screen-to-name-alist))
;;                        tab-width t))))
